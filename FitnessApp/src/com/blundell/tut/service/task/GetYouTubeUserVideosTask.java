...
/**
 * This is the task that will ask YouTube for a list of videos for a specified user
 * This class implements Runnable meaning it will be ran on its own Thread
...
public class GetYouTubeUserVideosTask implements Runnable {
	...
	public void run() {
		try {
			...
			List<Video2> videos = new ArrayList<Video2>();
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				videos.add(new Video2(title, url, thumbUrl));
			}
